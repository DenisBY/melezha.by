...
# RailsAdmin config file. Generated on November 01, 2011 13:59
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Melezha By', 'Admin']
  ...
  # config.excluded_models << [Address, Company, Contact, Service, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [Address, Company, Contact, Service, User]
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   # Found associations:
  #   field :address, :belongs_to_association
  #   field :contact, :belongs_to_association
  #   field :service, :belongs_to_association
  #   # Found columns:
  #   field :id, :integer
  #   field :title, :string
  #   field :overview, :text
  #   field :address_id, :integer        # Hidden
  #   field :contact_id, :integer        # Hidden
  #   field :service_id, :integer        # Hidden
  #   field :created_at, :datetime
  #   field :updated_at, :datetime
  #   # Sections:
  #   list do; end
